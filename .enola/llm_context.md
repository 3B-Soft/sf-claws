...
115 modules, 4288 symbols, grouped by area. Every module is in `facts.jsonl`, or query_facts(kind="module").

| Area | Modules | Symbols | Languages |
|------|---------|---------|-----------|
| `packages` | 114 | 4199 | typescript |
...
- `packages/extension/src/lib` — 190 symbols (typescript)
- `packages/admin-ui/src/modules/x/sessionDetailPage` — 107 symbols (typescript)
- `packages/extension/src/modules/x/chatThread` — 107 symbols (typescript)
...
- Files parsed: **260** / 392 seen (38 file(s) + 9 directory tree(s) skipped by ignore globs)
- Parse errors: 0
...
*Generated at 2026-09-18T13:54:54Z in 506.002625ms. 6104 facts, 85 insights.*
